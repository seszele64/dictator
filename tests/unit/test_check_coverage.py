...
def _passing_files(prefix: str = "") -> dict[str, dict]:
    ...
    return {
        ...
        f"{prefix}whisper_dictate/storage/audio_storage.py": _make_file_entry(90.38),
        f"{prefix}whisper_dictate/storage/orphan_scan.py": _make_file_entry(85.12),
        f"{prefix}whisper_dictate/util/paths.py": _make_file_entry(98.5),
